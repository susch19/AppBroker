...
namespace AppBroker.Main.Controller;
[Route("device")]
public class DeviceController : ControllerBase
{
    ...
    public DeviceController(IDeviceStateManager stateManager, IDeviceManager deviceManager, JavaScriptEngineManager engineManager, HistoryManager historyManager)
    {
