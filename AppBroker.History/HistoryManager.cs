...
using AppBroker.History.Models;
...
public class HistoryManager : IHistoryManager
{
    ...
    public List<HistoryRecord> GetHistoryFor(long deviceId, string propertyName, DateTime start, DateTime end)
    {
        ...
        return values
            ...
            .Concat(values.OfType<HistoryValueString>().Select(x => new HistoryRecord(x.Value, (long)new TimeSpan(x.Timestamp.Ticks).TotalMilliseconds)))
            .OrderBy(x => x.Ts)
            .ToList();
    }
