...
namespace AppBokerASP
{
    ...
    {
        public static DeviceManagerOld DeviceManager { get; private set; }
        ...
        public static void Main(string[] args)
        {
            ...
            DeviceManager = new DeviceManagerOld();
        ...
        private static void ConfigureLogger()
        {
            ...
            var logfile = new NLog.Targets.FileTarget("logfile") { FileName = Path.Combine("Logs", $"{DateTime.Now.ToString("yyyy_MM_dd")}.log"), Layout= "${longdate} ${logger} ${message}${exception:format=ToString}" };
        ...
        private static async void Dostuff()
        {
            ...
            //var lines = File.ReadAllLines("certfile.smarthome");
            //await UserManager.CreateUser(lines[1], lines[2], lines[3]);
            return;
