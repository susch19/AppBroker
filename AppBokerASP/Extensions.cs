...
namespace AppBokerASP
{
    public static class Extensions
    {
        ...
        public static DeviceModel GetModel<T>(this T t) where T : Device => new DeviceModel { Id = t.Id, TypeName = t.TypeName, FriendlyName = t.FriendlyName };

        public static T GetDevice<T>(this DeviceModel model) where T : Device, new() => new T { Id = model.Id, TypeName = model.TypeName, FriendlyName = model.FriendlyName };
